...
--lower-limit 0 \
DEF:e=/var/local/pvl.rrd:e_now:AVERAGE:step=5 \
AREA:e#AAFFAA \
...
if [ "$1" == 6 ]; then
	# KAZDE 2 HOD
	cd $IMG_PATH
	drive push -force -quiet -ignore-name-clashes \
		-destination GBO $IMG_PATH/*_6.png
elif [ "$1" == 24 ]; then
	# DENNE
	cd $IMG_PATH
	...
	# MESACNE
	cd $IMG_PATH
	cp ./vykon_672.png ./Archiv/vykon_mesacne/$date.png
	cp ./prud_672.png ./Archiv/prud_mesacne/$date.png
	cp ./pi_672.png ./Archiv/pi_mesacne/$date.png
	cp ./napetie_672.png ./Archiv/napetie_mesacne/$date.png
	cp ./rele_672.png ./Archiv/rele_mesacne/$date.png
